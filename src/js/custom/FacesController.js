...
class FacesController {
    ...
    updateDivisions () {
        const possibleDivisionX = this.findDivisions(this.divisions.x, this.divisions.lastX, 8);
        ...
        const possibleDivisionY = this.findDivisions(this.divisions.y, this.divisions.lastY, 8);
